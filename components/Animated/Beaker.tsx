export default function BeakerSymbol({classes, onClickEvent, pinned}) {

    
    return (
        pinned ? <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
